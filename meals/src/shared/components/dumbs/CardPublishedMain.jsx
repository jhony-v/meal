  ...
  return (
    <CardSimple {...props}>
      ...
      <UIContainer margin="1em 0">
        <UIText>
          <UITextSmooth size="small">{detailContext}</UITextSmooth>
        </UIText>
      </UIContainer>
      {publishedFooter && <UIContainer>{publishedFooter}</UIContainer>}
    </CardSimple>
  );
}
...
CardPublishedMain.propTypes = {
  ...
  publishedHeader: PropTypes.oneOfType([PropTypes.string, PropTypes.element])
    .isRequired,
